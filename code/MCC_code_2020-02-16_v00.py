# MCC_code_2020-02-16_v00.py
# 2020-02-16 Cedar Grove Studios
...
print("Battery: {:01.3f} volts".format((batt.value/65520)*6.6))
...
while True:
    ...
    if "displayio" in clock_display:
        displayio_disp.cursor = True
        displayio_disp.colon  = not displayio_disp.colon
    ...
    if current.tm_sec == 0 and not min_flag:
        ...
        b = (batt.value / 60732) * 6.6
        print("Battery: {:01.2f} volts".format(b))
        print(batt.value)
        print((b,))
