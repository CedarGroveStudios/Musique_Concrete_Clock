...
clock_alarm    = False      # Alarm is active = True
...
while True:
    ...
    if "displayio" in clock_display:
        new_xst_datetime, update_flag = displayio_disp.set_datetime(ds3231.datetime)
        if update_flag:  # update RTC Std Time with new datetime
           ds3231.datetime = new_xst_datetime
           print("update RTC's xST with", new_xst_datetime)
