# MCC_code_2020-02-18_v00.py
# 2020-02-18 Cedar Grove Studios
...
while True:
    ...
    if "displayio" in clock_display:
        new_xst_datetime, update_flag = displayio_disp.set_datetime(current)
        if update_flag: print("update RTC's xST with", new_xst_datetime)
